            ...
            <div class="content_admin">
                ...
                <div class="col9">
                    <div class="content">
                        <h1 id="h1">
                            Quản lí tin ẩm thực
                            <a id="a1" href="addFood.php" class="fa fa-plus"> Thêm</a>
                            <div style="clear: both;"></div>
                        </h1>
                            ...
                            <table id="myTable" class="table table-striped " cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <th>Ẩm thực Sài Gòn</th>
                                        <th>
                                            <a href="#" style="background: #575757;padding: 5px;color: white;border-radius: 10px;">Xóa</a>
                                            <a href="editFood.php" style="background: #575757;padding: 5px;color: white;border-radius: 10px;">Sửa</a>
                                        </th>
                                    </tr>                                   
                                </tbody>
                            </table>
