        ...
        <div class="admin">
            ...
            <div class="content_admin">
                ...
                <div class="col9">
                    <div class="content">
                        <h1 id="h1">
                            Quản lí tin kinh nghiệm du lịch
                            <a id="a1" href="addExp.php" class="fa fa-plus"> Thêm</a>
                            <div style="clear: both;"></div>
                        </h1>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <a href="editExp.php" style="background: #575757;padding: 5px;color: white;border-radius: 10px;">Sửa</a>
                                        </th>
                                    </tr>                                   
                                </tbody>
                            </table>
