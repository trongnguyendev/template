                        ...
                        <div class="content-item">
                            <table id="myTable" class="table table-striped " cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <tr>
                                        <th>002</th>
                                        <th>Galio - Html template e-commerce bán hàng đẹp, chuyên nghiệp, </th>
                                        <th><img src="../images/theme1.jpg" ></th>
                                        <th>Template e-commerce miễn phí, hổ trợ tốt trên mobile nhờ sử dụng Bootstrap, các hiệu ứng Animate nhẹ làm tăng sự chuyên nghiệp, giao diện web bán hàng đẹp và hổ trợ tốt Tiến...</th>
                                       
                                        <th>
                                            <a href="#" style="background: #575757;padding: 5px;color: white;border-radius: 10px;">Xóa</a>
                                            <a href="editProduct.php" style="background: #575757;padding: 5px;color: white;border-radius: 10px;">Sửa</a>
                                        </th>
                                    </tr>   
